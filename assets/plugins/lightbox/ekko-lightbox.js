const Lightbox = ($ => {
  ...
  class Lightbox {
    ...
    constructor($element, config) {
      ...
      let btn = `<button type="button" class="close" data-dismiss="modal" aria-label="${
      ...
      $(this._config.doc.body).append(
        `<div id="${
          this._modalId
        }" class="ekko-lightbox modal fade" tabindex="-1" tabindex="-1" role="dialog" aria-hidden="true">${dialog}</div>`
      );
      ...
      if (this._galleryName) {
        ...
        if (this._config.showArrows && this._$galleryItems.length > 1) {
          this._$lightboxContainer.append(
            ...
            }</a><a href="#">${this._config.rightArrow}</a></div>`
          );
